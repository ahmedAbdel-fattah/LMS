...
class AdminController extends Controller
{
    ...
    public function AddAdmin()
    {
        ...
        return view('admin.backend.pages.admin.add_admin', compact('roles', 'permissions'));
    }
    ...
    public function StoreAdmin(Request $request)
    {
        ...
        $user->role = $request->roles; // Assign role from the request
        ...
        if ($request->has('permission')) {
            $role = Role::findByName($request->roles); // Find the role by name
            if ($role) {
    ...
    public function EditAdmin($id)
    {
        ...
        $roles = Role::all();
        $permissions = Permission::all();
        return view('admin.backend.pages.admin.edit_admin', compact('user', 'roles', 'permissions'));
    }
