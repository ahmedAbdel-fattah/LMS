    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ route('carousel.index') }}"><i class='bx bx-radio-circle'></i>Manage Carousel </a>
                </li>
                <li> <a href="{{ route('features.index') }}"><i class='bx bx-radio-circle'></i>Manage Feature Box </a>
                </li>
                <li> <a href="{{ route('about.index') }}"><i class='bx bx-radio-circle'></i>Manage About </a>
                </li>
