...
Route::controller(AdminController::class)->group(function(){
    Route::get('/all/instructors','AllInstructor')->name('all.instructor');
...
Route::controller(ActiveUserController::class)->group(function(){
    ...
    Route::get('/all/instructor','AllInstructor')->name('all.instructors');
...
Route::get('/courses', [IndexController::class, 'CourseList'])->name(name: 'courses.list');
